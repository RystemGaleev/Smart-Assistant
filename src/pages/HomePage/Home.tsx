          ...
          <div className="main__wrapper">
            ...
            <div className="main__doc">
              ...
              <div className="main__column">
                ...
                <div className="main__text">
                  The Weather tab provides users with an interactive and easy-to-use interface to get information about the
                  current weather in any country or city. The weather tab displays detailed information such as temperature, wind
                  speed, humidity, and precipitation for the current day. The interface is designed to be user-friendly, providing
                  him with the necessary information quickly and efficiently.
                </div>
              </div>
            </div>
          </div>
